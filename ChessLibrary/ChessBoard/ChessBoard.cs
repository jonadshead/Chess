...
namespace Chess
{
    ...
    public partial class ChessBoard
    {
        ...
        /// </summary>
        public bool LoadedFromFen => !(FenBuilder is null);
        ...
        public EndGameInfo? EndGame
        {
            ...
            {
                endGame = value;
                if (!(value is null)) OnEndGameEvent();
            }
        }
        /// <summary>
        /// When true => use: EndGame. for more info on endgame(type, won side)
        /// </summary>
        public bool IsEndGame => !(EndGame is null);
        ...
        internal static void DropPiece(Move move, ChessBoard board)
        {
            ...
            board.pieces[move.NewPosition.Y, move.NewPosition.X] = new Piece(board.pieces[move.OriginalPosition.Y, move.OriginalPosition.X].Color, board.pieces[move.OriginalPosition.Y, move.OriginalPosition.X].Type);
        ...
        internal static void RestorePiece(Move move, ChessBoard board)
        {
            ...
            board.pieces[move.OriginalPosition.Y, move.OriginalPosition.X] = new Piece(board.pieces[move.NewPosition.Y, move.NewPosition.X].Color, board.pieces[move.NewPosition.Y, move.NewPosition.X].Type);
